...
describe(attributes.name, () => {
  ...
  jest.useFakeTimers().setSystemTime(new Date("2026-09-17"));
  ...
  it(
    ...
    async () => {
      ...
      expect(moviePages.movieData).toHaveLength(156);
      ...
      expect(data).toHaveLength(52); // Results are filtered from the original data
