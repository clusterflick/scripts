...
const systemInstruction = `
  ...
  The JSON must also contain \`isMultipleMovies\` boolean on whether the listing is describing a performance of multiple full-length movies. Sometimes referred to as 'double bills', 'movie marathons', etc.
